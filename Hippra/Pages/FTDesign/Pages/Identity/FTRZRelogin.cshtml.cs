...
{
    [AllowAnonymous]
    public class FTRZReloginModel : PageModel
    {
        private readonly UserManager<AppUser> _userManager;
        private readonly SignInManager<AppUser> _signInManager;
        private readonly ILogger<FTRZReloginModel> _logger;
        private readonly IEmailSender _emailSender;

        public FTRZReloginModel(SignInManager<AppUser> signInManager,
            ILogger<FTRZReloginModel> logger,
